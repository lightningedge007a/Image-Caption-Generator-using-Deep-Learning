...
t1=time.time()
# load the tokenizer
tokenizer = load(open('ImgCap_V5_VGG/tokenizer.pkl', 'rb'))
...
VGG_16 = load_model('ImgCap_V5_VGG/model-ep005-loss3.434-val_loss3.807.h5')
...
description = generate_desc(VGG_16, tokenizer, photo, max_length)
#print(description)
t2=time.time()
