...
t1=time.time()
# load the tokenizer
tokenizer = load(open('ImgCap_V4_VGG_vec/tokenizer.pkl', 'rb'))
...
VGG_16FT = load_model('ImgCap_V4_VGG_vec/model-ep004-loss3.440-val_loss3.771.h5')
...
description = generate_desc(VGG_16FT, tokenizer, photo, max_length)
#print(description)
t2=time.time()
